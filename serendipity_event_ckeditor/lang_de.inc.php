...
/**
 *  @file lang_de.inc.php 1.4.10 2014-10-11 Ian
 *  @version 1.4.10
...
<div class="msg_notice">
    <p><span class="icon-attention"></span> <strong>Abhängigkeiten:</strong> Deaktiviere body, extended und nugget global im <strong>NL2BR</strong> Plugin, <strong>oder</strong> per entry über das entryproperties plugin event <strong>und/oder</strong> für statische Seiten über die Entry "Textformatierungs" Option!</p>
</div>
