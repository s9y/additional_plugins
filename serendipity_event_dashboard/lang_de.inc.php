...
@define('PLUGIN_DASHBOARD_SEQUENCE_DESC', 'Hier können sie die Reihenfolge der verschiedenen Informationsblöcke festlegen.');

@define('PLUGIN_DASHBOARD_FUTURE', 'zukünftige Artikel');

@define('PLUGIN_DASHBOARD_LIMIT_COMMENTS_PENDING', 'Anzahl der noch zu bewilligenden Kommentare');
...
@define('PLUGIN_DASHBOARD_UPDATE', 'Prüfe Verfügbarkeit einer neuen stabilen Serendipity Version');
...
@define('PLUGIN_DASHBOARD_UPD', 'Update Notifier');
@define('PLUGIN_DASHBOARD_UPDATE_NOTIFIER', '<strong>Eine neue Serendipity Version ist verfügbar.</strong><br />Bitte updaten. Die neueste Version kann hier heruntergeladen werden: ');
