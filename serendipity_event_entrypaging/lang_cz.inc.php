...
@define('PLUGIN_ENTRYPAGING_RANDOM_BLAHBLAH', 'Nad odkazy dal¹í/pøedchozí zobrazí odkaz na náhodnì vybraný pøíspìvek.');
...
@define('PLUGIN_ENTRYPAGING_RANDOM_TEXT_NEXT_DESC', 'Zadej text odkazu. Pokud zùstane prázdný, bude jako text pou¾it nadpis pøíslu¹ného pøíspìvku (záznamu).');
