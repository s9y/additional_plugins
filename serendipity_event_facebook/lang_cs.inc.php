...
@define('PLUGIN_EVENT_FACEBOOK_HOWTO', 'Komentáøe jsou importovány k pøíspìvkùm blogu pøiøazením URL adresy odkazu na facebook (odkazí musí bıt veøejné!), pro toto zpìtné volání je pouita nastavená adresa Serendipity blogu (koøenová URL). Tento plugin nemùe bıt spuštìn pomocí pluginu cronjob, ani pomocí ruèního volání cronu (napø. wget) pøes blog (index.php?/plugin/facebookcomments).');
...
@define('PLUGIN_EVENT_FACEBOOK_VIA', 'Kterı øetìzec se má pøiávat k facebookovım komentáøùm?');
