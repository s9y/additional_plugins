...
@define('PLUGIN_EVENT_FACEBOOK_HOWTO', 'Komentáøe jsou importovány k pøíspìvkùm blogu pøiøazením URL adresy odkazu na facebook (odkazí musí být veøejné!), pro toto zpìtné volání je pou¾ita nastavená adresa Serendipity blogu (koøenová URL). Tento plugin nemù¾e být spu¹tìn pomocí pluginu cronjob, ani pomocí ruèního volání cronu (napø. wget) pøes blog (index.php?/plugin/facebookcomments).');
...
@define('PLUGIN_EVENT_FACEBOOK_VIA', 'Který øetìzec se má pøiávat k facebookovým komentáøùm?');
