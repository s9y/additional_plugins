<?php # lang_cs.inc.php 1.1 2013-06-22 11:21:40 VladaAjgl $
...
<li>Pro aktualizaci tohoto pluginu z verze menší než v.0.8 a nìkterých FCKeditorù verze 2.x mezi verzemi v.2.6 a 2.10, zálohujte svoje nastavení (pokud jste si nìjaké pøizpùsobovali) a smažte obsah starého adresáøe <em style="color: #777">fckeditor/</em>. Pak následujte instrukce z  "Instalaèního prùvodce".</li>
</ul>');
@define('PLUGIN_EVENT_FCKEDITOR_INSTALL',     '<br /><br /><strong>Instalaèní prùvodce:</strong><br />
<ul>
