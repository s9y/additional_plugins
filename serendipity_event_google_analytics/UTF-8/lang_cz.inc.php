...
@define('PLUGIN_EVENT_GOOGLE_ANALYTICS_DESC', 'Tento plugin přidává vašemu blogu rošířené funkce Google Analytics 4 jako je například sledování odkazů nebo stažených souborů.');
