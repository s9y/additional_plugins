...
@define('PLUGIN_EVENT_LIGHTBOX_INIT_JS_DESC', 'Nìkteré typy Lightboxu (napø. prettyPhoto) umožòují zadání libovolného objektu s nastavním, takže mùžete zadat napø. "(social_tools: false)". Currently works with prettyPhoto only.');