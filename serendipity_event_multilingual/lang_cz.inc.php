...
@define('PLUGIN_EVENT_MULTILINGUAL_DESC',               'Umo¾òuje vytvoøit pøíspìvek (záznam) ve více jazykových variantách. Obsahuje té¾ fromuláø pro výbìr základního jazyka blogu.');
@define('PLUGIN_EVENT_MULTILINGUAL_NEEDTOSAVE',         'Pøíspìvek musí být ulo¾en pøed tím, ne¾ mù¾ete zaèít psát jeho verzi v cizím jazyce. Mù¾ete pøíspìvek ulo¾it té¾ jako koncept.');
...
@define('PLUGIN_EVENT_MULTILINGUAL_PLACE_ADDSPECIAL',   '"multilingual_footer" pro volitelný výstup do ¹ablony Smarty');
...
@define('PLUGIN_SIDEBAR_MULTILINGUAL_LANGSWITCH',        'Vynutit plné pøepnutí jazyka?');
@define('PLUGIN_SIDEBAR_MULTILINGUAL_LANGSWITCH_DESC',   'Má se pøi vybrání jazykové verze jednotlivého pøíspìvku pøepnout do zvoleného jazyka kompletnì i celé rozhraní blogu?');