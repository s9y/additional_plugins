...
@define('PLUGIN_EVENT_MULTILINGUAL_TAGTITLE', 'Übersetzung des Blogtitels');
@define('PLUGIN_EVENT_MULTILINGUAL_TAGTITLE_DESC', 'Aktiviert {{!<lang>}}<text>{{--}} tags für den Blogtitel oder benutzt die im nicht-tag-Modus übersetzten Eintragstitel.');
@define('PLUGIN_EVENT_MULTILINGUAL_TAGENTRIES', 'Übersetzung von Artikeln und Artikeltiteln per tag');
@define('PLUGIN_EVENT_MULTILINGUAL_TAGENTRIES_DESC', 'Aktiviert {{!<lang>}}<text>{{--}} tags für Artikel');
@define('PLUGIN_EVENT_MULTILINGUAL_TAGSIDEBAR', 'Übersetzung von Seitenleisten-Einträgen per tag');
@define('PLUGIN_EVENT_MULTILINGUAL_TAGSIDEBAR_DESC', 'Aktiviert {{!<lang>}}<text>{{--}} tags für Seitenleisten-Einträge');
...
@define('PLUGIN_EVENT_MULTILINGUAL_PLACE_ADDSPECIAL', '"multilingual_footer" für benutzerdefinierten Smarty output');

@define('PLUGIN_EVENT_MULTILINGUAL_LANGSWITCH', 'Vollständigen Sprachwechsel erzwingen?');
@define('PLUGIN_EVENT_MULTILINGUAL_LANGSWITCH_DESC', 'Die Auswahl einer Übersetzung eines Blogeintrags ändert die Sprache des gesamten Blogs');

@define('PLUGIN_EVENT_MULTILINGUAL_HIDEENTRIES', 'Nicht übersetzte Artikel auf der Startseite ausblenden?');
@define('PLUGIN_EVENT_MULTILINGUAL_HIDEENTRIES_DESC', 'Sollen Artikel in der Standardsprache angezeigt werden, die in der gewählten Sprache nicht verfügbar sind?');
