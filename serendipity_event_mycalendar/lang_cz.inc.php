...
@define('PLUGIN_MYCALENDAR_EVENTLIST',          'Toto je list nadcházejících událostí. Ke smazání události jednodu¹e vyma¾te obì pole.');
@define('PLUGIN_MYCALENDAR_EVENTNAME',          'Název události');
@define('PLUGIN_MYCALENDAR_EVENTURI',           'Pøípadná URL adresa, která se vá¾e k události');
...
@define('PLUGIN_MYCALENDAR_SIDE_DESC',          'Zobrazuje Vá¹ osobní kalendáø s X nadcházejícími událsotmi.');
...
@define('PLUGIN_MYCALENDAR_SIDE_PRUNE',         'Èi¹tìní');
...
@define('PLUGIN_MYCALENDAR_SIDE_SKIPFIRSTFUTURE','Nezobrazovat odpoèet pro nejbli¾¹í událost?');
