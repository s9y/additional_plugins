<?php # lang_cs.inc.php 1.1 2009-11-21 11:38:19 VladaAjgl $
...
@define('PLUGIN_EVENT_PICASA_PROP_PATH_DESC',       'Cesta k adresáøi, kde jsou uložena fotoalba Picasa na webserveru.');
@define('PLUGIN_EVENT_PICASA_PROP_JSWINDOW',        'Otevøít okno pomocí JavaScriptu');
@define('PLUGIN_EVENT_PICASA_PROP_JSWINDOW_DESC',   'Každý z obrázkù se mùže zobrazovat ve vìtší velikosti v novém oknì. Pomocí JavaScriptu mùže být velikost tohoto okna automaticky pøizpùsobena velikosti obrázku.');
@define('PLUGIN_EVENT_PICASA_PROP_SHOWTITLE',       'Zobrazovat nadpis fotoalb');
@define('PLUGIN_EVENT_PICASA_PROP_SHOWTITLE_DESC',  'Má se v pøíspìvku zobrazovat název fotoalba? Bude použito pouze pokud se vzhled negeneruje pomocí Smarty-šablony.');
...
@define('PLUGIN_EVENT_PICASA_ERR_MISSING_RSS',      'Omlouváme se, žádné obrázky nebyly pøijaty. Tento URL odkaz pracuje správnì pouze pøi nahrávání obrázkù pomocí tlaèítka Picasa.');
@define('PLUGIN_EVENT_PICASA_ERR_UPLOAD_DIR_ALREADY_EXISTS','Adresáø pro stahování obrázkù již existuje');
...
@define('PLUGIN_EVENT_PICASA_UPLOAD_REMEMBER_LOGIN','Pamatovat pøihlašovací údaje?');
...
@define('PLUGIN_EVENT_PICASA_UPLOAD_SUCCESS',       'Úspìšnì nahráno!');
...
@define('PLUGIN_EVENT_PICASA_EXAMPLE_STEP4',        'Otevøete jej v textovém editoru. Jedná se o xml soubor. Nahraïte všechny výskyty "mysite.com" jménem stránky s Vaším blogem. Dále nahraïte  "mysite.com/serendipity/index.php" platnou cestou k souboru index.php na Vašem serendipity blogu.');
...
@define('PLUGIN_EVENT_PICASA_EXAMPLE_STEP7',        'Vložte soubor .pbz do adresáøe s tlaèítky vaší picasy, což je typicky  "C:\Program Files\Google\Picasa\buttons".');
