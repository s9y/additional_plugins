<?php # lang_cs.inc.php 1.0 2009-11-21 11:52:12 VladaAjgl $
...
@define('PLUGIN_PRETTIFY_DESC', 'Použít skript Prettify pro vybroušení obsahu mezi tagy &lt;PRE&gt; pro jednoduché zvýrazòování syntaxe.');
...
@define('PLUGIN_PRETTIFY_GENERICPRE', 'Jak má Prettify zvýrazòovat syntaxi uvnitø &lt;PRE&gt; tagu?');
@define('PLUGIN_PRETTIFY_GENERICPRE_DESC', 'Použít obecná pravidla zvýraznìní syntaxe na všechen obsah uvnitø &lt;PRE&gt; tagu bez ohledu na upøesnìní jazyka ve tøíde (class) tagu?');
@define('PLUGIN_PRETTIFY_GENERICPRE_TRUE', 'Obecný');
@define('PLUGIN_PRETTIFY_GENERICPRE_FALSE', 'Podle jazyka');
@define('PLUGIN_PRETTIFY_GENERICCODE', 'Jak má Prettify zvýrazòovat syntaxi uvnitø &lt;CODE&gt; tagu?');
@define('PLUGIN_PRETTIFY_GENERICCODE_DESC', 'Použít obecná pravidla zvýraznìní syntaxe na všechen obsah uvnitø &lt;CODE&gt; tagu bez ohledu na upøesnìní jazyka ve tøíde (class) tagu?');
@define('PLUGIN_PRETTIFY_GENERICCODE_TRUE', 'Obecný');
@define('PLUGIN_PRETTIFY_GENERICCODE_FALSE', 'Podle jazyka');
@define('PLUGIN_PRETTIFY_CONVERTANGLE', 'Poskytnout tlaèítko v editoru na konverzi špièatých závorek');
