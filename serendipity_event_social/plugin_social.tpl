...
{foreach $services as $service}
    {if $service == 'facebook'}
        <a href="https://www.facebook.com/sharer/sharer.php?u={$url|escape:url}" target="_blank" rel="noopener" class="{$service}" title="{$CONST.PLUGIN_EVENT_SOCIAL_SHARE_TITLE|sprintf:Facebook}">
            ...
            {$CONST.PLUGIN_EVENT_SOCIAL_SHARE_ACTION}
        </a>
    {/if}
    {if $service == 'twitter'}
    ...
    {/if}
    {if $service == 'mastodon'}
        <a href="https://tootpick.org/#text={"$title $url"|escape:url}" target="_blank" rel="noopener" class="{$service}" title="{$CONST.PLUGIN_EVENT_SOCIAL_SHARE_TITLE|sprintf:Mastodon}">
    ...
    {/if}
    {if $service == 'bluesky'}
        <a href="https://bsky.app/intent/compose?text={"$title $url"|escape:url}" target="_blank" rel="noopener" class="{$service}" title="{$CONST.PLUGIN_EVENT_SOCIAL_SHARE_TITLE|sprintf:Bluesky}">
