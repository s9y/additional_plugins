...
<?php
                ...
                case 'backend_sidebar_entries_event_display_statistics':
                    ...
                    if ($this->get_config('stat_all') == 'yes') {
                        ...
                        $comments = serendipity_db_query("SELECT count(id) FROM {$serendipity['dbPrefix']}comments WHERE type = 'NORMAL' AND subscribed = 'true' GROUP BY email");
                        $subscriber_count = is_array($comments) ? count($comments) : 0;
