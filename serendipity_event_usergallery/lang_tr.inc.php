 ...
 */
        ...
        @define('PLUGIN_EVENT_USERGALLERY_DESC', 'Anonim kullanýcý-ziyaretçilerin Serendipity Medya Galerisini görmelerine izin verir');
        ...
        @define('PLUGIN_EVENT_USERGALLERY_STYLE_DESC', 'Kullanmak istediðiniz galeri stilini seçin. "Medya Kütüphanesi" dizinler arasýnda gezinmenize ve arama yapmanýza imkan verir, "Küçükresim Sayfasý" dizindeki küçükresimlerin gösterilmesini saðlar ve týklandýðýnda resimler yeni bir pencerede açýlýr');
