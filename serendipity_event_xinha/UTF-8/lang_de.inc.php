...
<ul>
<li>Laden Sie XINHA von http://xinha.python-hosting.com/</li>
<li>Entpacke Sie es in ein a "XINHA" Verzeichnis unterhalb von ' . dirname(__FILE__) . '</li>
<li>Geben Sie den relativen HTTP Pfad zu diesem "XINHA" Verzeichnise in diese Plugin Konfiguration ein.</li>
