...
@define('PLUGIN_GOOGLE_LAST_QUERY_TITLE',                   "Síðasta leit á Google, Yahoo, Bing, Scroogle");
@define('PLUGIN_GOOGLE_LAST_QUERY_DESC',                    "Sýnir síðustu leit á Google/Yahoo/Bing/Scroogle sem leiddi til þessarar síðu");
@define('PLUGIN_GOOGLE_LAST_QUERY_PROP_TITLE',              "Titill");
@define('PLUGIN_GOOGLE_LAST_QUERY_PROP_TITLE_DESC',         "Titill hliðarrammakubbs");
@define('PLUGIN_GOOGLE_LAST_QUERY_PROP_COUNT',              "Fjöldi");
@define('PLUGIN_GOOGLE_LAST_QUERY_PROP_COUNT_DESC',         "Hversu mörg leitarskilyrði á að sýna?");
