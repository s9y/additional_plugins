...
@define('PLUGIN_GOOGLE_QS_ADSENSE_DESC',		'Vkládat identifikátor služby Google AdSense for Search po části name="client". Obvykle má tvar "pub-1234567890123456". Ponechte prázdné, pokud nepoužíváte Google AdSense.');
@define('PLUGIN_GOOGLE_QS_BACKGROUND',		'Barva pozadí');
@define('PLUGIN_GOOGLE_QS_TEXT',		'Barva textu');
@define('PLUGIN_GOOGLE_QS_BORDER',		'Barva rámečku');
...
@define('PLUGIN_GOOGLE_QS_LOGO_PLACE',		'Umístění loga (pouze u AdSense)');
...
@define('PLUGIN_GOOGLE_QS_SUBMIT',		'Zobrazit tlačítko pro zadání vyhledávání');
