...
@define('GENERAL_PLUGIN_BOX_COLS', 				'Shoutbox Spalten');
@define('GENERAL_PLUGIN_BOX_COLS_BLAHBLAH', 	'Spaltenanzahl, die die Shoutbox Eingabe breit sein soll.');
@define('GENERAL_PLUGIN_BOX_ROWS', 				'Shoutbox Reihen');
@define('GENERAL_PLUGIN_BOX_ROWS_BLAHBLAH', 	'Reihenanzahl, die die Shoutbox Eingabe lang sein soll.');
