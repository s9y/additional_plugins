...
@define('PLUGIN_SIDEBARLOGO_DESC', 'Zeigt ein Logo mit einer Beschreibung und allen relevanten Informationen in der Seitenleiste.');
...
@define('PLUGIN_SIDEBARLOGO_IMAGESTYLE', 'Bildstyle');
@define('PLUGIN_SIDEBARLOGO_IMAGESTYLE_DESC', 'Style, der für das Bild verwendet werden soll. Mit dem Zeichen "." beginnen, um eine CSS-ID zu spezifizieren, mit "#" beginnen, um eine Klasse zu spezifizieren oder alternativ einen Inline-Style direkt eingeben');
@define('PLUGIN_SIDEBARLOGO_DESCRIPTIONSTYLE', 'Beschreibungstyle');
@define('PLUGIN_SIDEBARLOGO_DESCRIPTIONSTYLE_DESC', 'Style, der für die Beschreibung verwenden werden soll. to use for your description.  Mit dem Zeichen "." beginnen, um eine CSS-ID zu spezifizieren, mit "#" beginnen, um eine Klasse zu spezifizieren, direkt Inline-Style definieren oder frei lassen, um das Standardseitenleistenstyling zu verwenden (empfohlen)');
?>