<?php # lang_cz.inc.php 1.0 2009-08-14 20:11:15 VladaAjgl $
...
@define('PLUGIN_SIDEBAR_WEATHER_NAME', 'Počasí');
@define('PLUGIN_SIDEBAR_WEATHER_DESC', 'V postranním sloupci zobrazí aktuální počasí ve zvoleném místě.');
@define('PLUGIN_SIDEBAR_WEATHER_TITLE', 'Nadpis');
@define('PLUGIN_SIDEBAR_WEATHER_TITLE_BLAHBLAH', 'Nadpis bloku s počasím');
@define('PLUGIN_SIDEBAR_WEATHER_METAR', 'Zdroj meteorologických dat METAR, například EDDK');
@define('PLUGIN_SIDEBAR_WEATHER_METAR_BLAHBLAH', 'Zdroje meteodat METAR najdete například na http://weather.noaa.gov/');
@define('PLUGIN_SIDEBAR_WEATHER_TIMEZONE', 'Vaše časové pásmo');
@define('PLUGIN_SIDEBAR_WEATHER_TIMEZONE_BLAHBLAH', 'Časové pásmo je relativní vůči greenwichskému času (např. +10 nebo -5)');
...
@define('PLUGIN_SIDEBAR_WEATHER_DATA_WINDDIRECTION', 'Směr větru:');
@define('PLUGIN_SIDEBAR_WEATHER_DATA_VISIBILITY', 'Viditelnost:');
@define('PLUGIN_SIDEBAR_WEATHER_DATA_CLOUDS_AMOUNT', 'Množství mraků:');
@define('PLUGIN_SIDEBAR_WEATHER_DATA_CLOUDS_HEIGHT', 'Výška mraků:');
...
@define('PLUGIN_SIDEBAR_WEATHER_DATA_V', 'Proměnlivý');
@define('PLUGIN_SIDEBAR_WEATHER_CACHE_ENTRIES', 'Cachovat informace o počasí?');
@define('PLUGIN_SIDEBAR_WEATHER_CACHE_ENTRIES_DESC', 'Vyžaduje nainstalovaný PEAR:Cache.');
@define('PLUGIN_SIDEBAR_WEATHER_CACHE_DIRECTORY', 'Adresář pro cachování:');
@define('PLUGIN_SIDEBAR_WEATHER_CACHE_DIRECTORY_DESC', 'Server musí mít práva čtení a zápisu do tohoto adresáře.');
