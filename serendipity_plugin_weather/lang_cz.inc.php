...
@define('PLUGIN_SIDEBAR_WEATHER_TIMEZONE', 'Va¹e èasové pásmo');
...
@define('PLUGIN_SIDEBAR_WEATHER_DATA_CLOUDS_AMOUNT', 'Mno¾ství mrakù:');
@define('PLUGIN_SIDEBAR_WEATHER_DATA_CLOUDS_HEIGHT', 'Vý¹ka mrakù:');
...
@define('PLUGIN_SIDEBAR_WEATHER_DATA_RAIN', 'Srá¾ky:');
...
@define('PLUGIN_SIDEBAR_WEATHER_CACHE_ENTRIES_DESC', 'Vy¾aduje nainstalovaný PEAR:Cache.');
