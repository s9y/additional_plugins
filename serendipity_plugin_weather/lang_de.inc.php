<?php # lang_de.inc.php 1.0 2009-08-20 10:18:13 VladaAjgl $
...
@define('PLUGIN_SIDEBAR_WEATHER_NAME', 'Wetter');
   ...
   @define('PLUGIN_SIDEBAR_WEATHER_DATA_S', 'Süd');
   @define('PLUGIN_SIDEBAR_WEATHER_DATA_SE', 'Süd-Ost');
   @define('PLUGIN_SIDEBAR_WEATHER_DATA_SW', 'Süd-West');
   @define('PLUGIN_SIDEBAR_WEATHER_DATA_SSW', 'Süd/Süd-West');
   @define('PLUGIN_SIDEBAR_WEATHER_DATA_SSE', 'Süd/Süd-Ost');
   @define('PLUGIN_SIDEBAR_WEATHER_DATA_E', 'Ost');
   @define('PLUGIN_SIDEBAR_WEATHER_DATA_ESE', 'Ost/Süd-Ost');
   @define('PLUGIN_SIDEBAR_WEATHER_DATA_ENE', 'Ost/Nord-Ost');
   @define('PLUGIN_SIDEBAR_WEATHER_DATA_N', 'Nord');
   @define('PLUGIN_SIDEBAR_WEATHER_DATA_NW', 'Nord-West');
   @define('PLUGIN_SIDEBAR_WEATHER_DATA_NE', 'Nord-Ost');
   @define('PLUGIN_SIDEBAR_WEATHER_DATA_NNW', 'Nord/Nord-West');
   @define('PLUGIN_SIDEBAR_WEATHER_DATA_NNE', 'Nord/Nord-Ost');
   @define('PLUGIN_SIDEBAR_WEATHER_DATA_W', 'West');
   @define('PLUGIN_SIDEBAR_WEATHER_DATA_WNW', 'West/Nord-West');
   @define('PLUGIN_SIDEBAR_WEATHER_DATA_WSW', 'West/Süd-West');
   @define('PLUGIN_SIDEBAR_WEATHER_DATA_V', 'Unterschiedlich');
   @define('PLUGIN_SIDEBAR_WEATHER_CACHE_ENTRIES', 'Wetterinformationen cachen?');
   @define('PLUGIN_SIDEBAR_WEATHER_CACHE_ENTRIES_DESC', 'PEAR::Cache muss installiert sein');
   @define('PLUGIN_SIDEBAR_WEATHER_CACHE_DIRECTORY', 'Verzeichnis für den Cache:');
   @define('PLUGIN_SIDEBAR_WEATHER_CACHE_DIRECTORY_DESC', 'Server muss Schreib- und Lesezugriffe auf dieser Verzeichnis ermöglichen.');

// Next lines were translated on 2009/08/20
@define('PLUGIN_SIDEBAR_WEATHER_PIXEL_DIRECTORY', 'HTTP Pfad zu den Wetter-Bildern');