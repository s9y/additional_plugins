<?php # $Id: lang_en.inc.php,v 1.2 2006/07/05 07:39:14 garvinhicking Exp $
...
@define('PLUGIN_SIDEBAR_WEATHER_CACHE_ENTRIES', 'Cache weather information?');
@define('PLUGIN_SIDEBAR_WEATHER_CACHE_ENTRIES_DESC', 'Must have PEAR:Cache installed.');
@define('PLUGIN_SIDEBAR_WEATHER_CACHE_DIRECTORY', 'Directory for cache information:');
@define('PLUGIN_SIDEBAR_WEATHER_CACHE_DIRECTORY_DESC', 'Server must have read and write permissions to this directory.');
@define('PLUGIN_SIDEBAR_WEATHER_PIXEL_DIRECTORY', 'HTTP path to your weather-images');
